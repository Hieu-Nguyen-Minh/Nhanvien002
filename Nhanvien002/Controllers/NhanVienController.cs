...
namespace Nhanvien002.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NhanVienId,HoTen,Email,PhongBan,MucLuong")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NhanVienId,HoTen,Email,PhongBan,MucLuong")] NhanVien nhanVien)
        {
